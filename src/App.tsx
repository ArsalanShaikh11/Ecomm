...
import { Zap, Star, TrendingUp, Shield, Truck, Award, Users } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header onSearch={setSearchQuery} onCategoryFilter={setCurrentCategory} />
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-purple-900 text-white py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Discover cutting-edge electronics and gadgets that transform how you work, play, and connect with the world.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-xl hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">Free delivery on all orders. Fast and reliable shipping worldwide.</p>
            </div>
            <div className="text-center p-6 rounded-xl hover:shadow-lg transition-shadow">
            ...
            <div className="text-center p-6 rounded-xl hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">Round-the-clock customer support for all your tech needs.</p>
            </div>
          </div>
        </div>
      </section>
